...
const store = makeInMemoryStore({ logger: pino().child({ level: 'silent', stream: 'store' }) })	
    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      let up = `📡 *Successfully Connected to WhatsApp!* \n\n *Welcome to KAVIYA MD!🎉* \n\nYour WhatsApp user bot is now securely connected and active.\n\n✅ *Features Enabled* :\n• Send & receive messages\n• Powerful automation\n• Secure and stable session\n\n\n *Thank you for using KAVIYA MD! 💚*\n\nPREFIX: ${prefix}`;
      conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/v3wj7s.png` }, caption: up });
    }
  });
...
externalAdReply: { 
title: 'KAVIYA-SONG-DL',
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://whatsapp.com/channel/0029Vac3pnlBlHpXLrUBym3a" ,
thumbnailUrl: 'https://files.catbox.moe/alyh8i.jpg' ,
